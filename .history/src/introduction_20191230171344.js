    ...
    render() {
        ...
        return (
            <div id="introduction-wrap">
                <picture>
                    <source media="(min-width: 601px)" srcSet="/Images/background.jpg" />
                    <source media="(max-width: 600px)" srcSet="/Images/background-mobile.jpg" />
                    <img src="/Images/background.jpg" alt="Flowers" style="width:auto;" />
                </picture>
